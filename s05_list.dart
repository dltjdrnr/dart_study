...
void main(List<String> args) {
  ...
  print(tempList1.map((tempList1) => tempList1 * 2));
  ...
  tempList1.forEach((tempList1) => {print(tempList1)});
  // 문제 13. any를 이용해서 tempList1에 3이 있는지 확인하고 출력하시오.
  print(tempList1.any((tempList1) => tempList1 == 3));
  // 문제 14. every를 이용해서 tempList1의 모든 요소가 3보다 작은지 확인하고 출력하시오.
  print(tempList1.every((tempList1) => tempList1 < 3));
